...
namespace MOM.Forms
{
	partial class frmReports
	{
		...
		private void InitializeComponent()
		{
			...
			tbMembersByAgeFrom = new DateTimeTextBox();
			label8 = new Label();
			btnMembersByAgeGenerate = new Button();
			tbMembersByAgeTo = new DateTimeTextBox();
			label9 = new Label();
			...
			tabPage3.Size = new Size(630, 256);
			tabPage3.TabIndex = 3;
			...
			tableLayoutPanel4.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
			tableLayoutPanel4.Size = new Size(624, 250);
			tableLayoutPanel4.TabIndex = 7;
			// 
			// btnMemberGenerate
			// 
			btnMemberGenerate.Anchor = AnchorStyles.Top | AnchorStyles.Right;
			btnMemberGenerate.Location = new Point(255, 110);
			...
			tableLayoutPanel5.RowStyles.Add(new RowStyle(SizeType.Percent, 50F));
			tableLayoutPanel5.Size = new Size(624, 245);
			...
			panel3.Location = new Point(123, 37);
			panel3.Name = "panel3";
			...
			cmbMembersByAgeOrderBy.Size = new Size(245, 28);
			...
			btnMembersByAgeGenerate.Location = new Point(254, 136);
			btnMembersByAgeGenerate.Name = "btnMembersByAgeGenerate";
			btnMembersByAgeGenerate.Size = new Size(121, 30);
			btnMembersByAgeGenerate.TabIndex = 2;
			btnMembersByAgeGenerate.Text = "Generate";
		...
		private DateTimeTextBox tbMembersByAgeFrom;
		private Label label8;
		private Button btnMembersByAgeGenerate;
		private DateTimeTextBox tbMembersByAgeTo;
